  ...
  Future<void> _requestPermissions() async {
    try {
      ...
      if (status.isDenied) {
        ...
        // Show dialog to user explaining why notifications are needed
        Get.snackbar(
...
String _getChannelId(String type) {
  switch (type) {
    case 'message':
      return FCMNotificationService._messageChannelId;
    case 'friendRequest':
    case 'friendAccepted':
      return FCMNotificationService._friendChannelId;
    default:
      return FCMNotificationService._generalChannelId;
  }
}
